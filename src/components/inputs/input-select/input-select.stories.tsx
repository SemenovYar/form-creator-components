...
const formSize = createForm();

stories
  .add('default', () => {
    const { controller } = useForm({ form: formDef });
    const values = useStore(formDef.$values);
  ...
  .add('sizes', () => {
    const { controller } = useForm({ form: formSize });
    const values = useStore(formSize.$values);
